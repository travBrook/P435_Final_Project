...
def run():
    ...
    #Spawn Client
<<<<<<< HEAD
    proc_id = subprocess.Popen([sys.executable, './client.py', config.CLIENT1_IP, config.MASTER_IP,'Client1', 'linear1'])
    #time.sleep(0.13)
    proc_id = subprocess.Popen([sys.executable, './client.py', config.CLIENT2_IP, config.MASTER_IP,'Client2',  'linear2'])
   # time.sleep(0.13)
    '''
...
>>>>>>> e42120cd9b18cbb613d694cd57c057ba87b398b8
